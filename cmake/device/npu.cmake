...
find_library(NPU_DDK_CPUCL_FILE NAMES cpucl
  PATHS ${NPU_DDK_ROOT}/${NPU_SUB_LIB_PATH}
  NO_DEFAULT_PATH)
...
if(NOT NPU_DDK_CPUCL_FILE)
  message(FATAL_ERROR "Can not find NPU_DDK_CPUCL_FILE in ${NPU_DDK_ROOT}")
else()
  message(STATUS "Found NPU_DDK CPUCL Library: ${NPU_DDK_CPUCL_FILE}")
  add_library(npu_ddk_cpucl SHARED IMPORTED GLOBAL)
  set_property(TARGET npu_ddk_cpucl PROPERTY IMPORTED_LOCATION ${NPU_DDK_CPUCL_FILE})
endif()
