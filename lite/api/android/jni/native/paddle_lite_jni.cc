...
paddle_lite_MobileConfig_2(JNIEnv *env,
  ...
  config.set_model_buffer(reinterpret_cast<char *>(decrypt_model_output),
                          decrypt_model_output_size,
                          reinterpret_cast<char *>(decrypt_param_output),
                          decrypt_param_output_size);

  free(decrypt_model_output);
  decrypt_model_output = NULL;
  free(decrypt_param_output);
  decrypt_param_output = NULL;
